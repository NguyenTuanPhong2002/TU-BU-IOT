...
THT_StatusTypeDef RFM95_setCodingRate(RFM95_HandleTypeDef *const me, const uint8_t CR);
THT_StatusTypeDef RFM95_setBandwidth(RFM95_HandleTypeDef *const me, const uint8_t BW);
THT_StatusTypeDef RFM95_setCRCMode(RFM95_HandleTypeDef *const me, const uint8_t CRCMode);
...
THT_StatusTypeDef RFM95_setRFPowerAmplifier(RFM95_HandleTypeDef *const me, const uint8_t paSelect, uint8_t Pout);
...
THT_StatusTypeDef RFM95_setFrequency(RFM95_HandleTypeDef *const me, const uint32_t frequency);
THT_StatusTypeDef RFM95_transmit(RFM95_HandleTypeDef *const me, uint8_t *pData, uint8_t size, uint32_t timeout);
// THT_StatusTypeDef RFM95_receive(RFM95_HandleTypeDef * const me, uint8_t mode, uint8_t pBuffer[], uint8_t size, uint32_t timeout);
...
THT_StatusTypeDef RFM95_mappingDIO0(RFM95_HandleTypeDef *const me, const uint8_t mappingMode);
